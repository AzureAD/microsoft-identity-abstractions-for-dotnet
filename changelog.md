...
- Added XML comments with recommendations on which CredentialSource not to use in production. See [#167](ttps://github.com/AzureAD/microsoft-identity-abstractions-for-dotnet/pull/167) for details.
